...
namespace Infin8.Coapp.Repository
{
    public  interface ILoanTrnRepository
    {
        ...
        Task<List<LoanDetailsVM>> GetLoanDetailsList2ByLoanIdsAsync(decimal[] loanIds, string brCode);
        ...
        Task<List<DtoTermDepositLoan>> GetTDLoanDataByTDIds(List<decimal> tdIdList,string brCode);
