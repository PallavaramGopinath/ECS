...
{
    public  class DtoLoanDisbursementLT
    {
        ...
        public string? MortgageBondRegistrationNo { get; set; }
        public DateTime? MortgageBondRegistrationDate { get; set; }
        public string? SubRegistrarOfficeName { get; set; }
        public string? SARDBLoanNo { get; set; }
        public string? DVNo { get; set; }
        public List<DtoLoanMembers>? LoanMembersList { get; set; }
