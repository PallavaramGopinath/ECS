...
{
    public interface ITermDepositTrnHandler
    {
        ...
        Task<SecurityDepositVM> CalculateSecurityDepositInterest(decimal empId, int schemeId, DateTime toDate, string brCode);
    }
}
